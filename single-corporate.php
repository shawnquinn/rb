...
<div class="wrapper" id="corporate-single">
								...
								<div id="bio-contact" class="col-md-5 col-6 text-left pr-0">
									...
									?>
										<div id="practice-lead" class="row align-items-center">
											...
											<div class="col-md-6">
												<h4 class="text-center text-sm-left"><?php echo get_the_title($post_object->ID); ?></h4>
												<p class="text-center text-sm-left"><?php the_field('sub_title', $post_object->ID) ?></p>
