...
var browserSyncWatchFiles = ["./css/*.min.css", "./js/*.min.js", "./**/*.php"];
...
gulp.task("cleancss", function() {
  return gulp
    .src("./css/*.min.css", { read: false }) // much faster
...
gulp.task("copy-assets", ["clean-source"], function() {
  ...
  gulp
    .src(basePaths.node + "font-awesome/fonts/**/*.{ttf,woff,woff2,eof,svg}")
    .pipe(gulp.dest("./fonts"));

  // Copy all Font Awesome SCSS files
  gulp
    .src(basePaths.node + "font-awesome/scss/*.scss")
    .pipe(gulp.dest(basePaths.dev + "/sass/fontawesome"));

  // Copy jQuery
  gulp
    .src(basePaths.node + "jquery/dist/*.js")
    .pipe(gulp.dest(basePaths.dev + "/js"));

  // _s SCSS files
  gulp
    .src(basePaths.node + "undescores-for-npm/sass/**/*.scss")
    .pipe(gulp.dest(basePaths.dev + "/sass/underscores"));

  // _s JS files
  gulp
    .src(basePaths.node + "undescores-for-npm/js/*.js")
    .pipe(gulp.dest(basePaths.dev + "/js"));

  // Copy Popper JS files
  gulp
    .src(basePaths.node + "popper.js/dist/umd/popper.min.js")
    .pipe(gulp.dest(basePaths.js));

  gulp
    .src(basePaths.node + "popper.js/dist/umd/popper.js")
    .pipe(gulp.dest(basePaths.js));
  return stream;
});
